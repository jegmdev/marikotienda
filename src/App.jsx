...
// Importación del logo para que Vite y Vercel lo procesen correctamente
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <nav className="bg-[#f989b7] text-white p-4 sticky top-0 z-50 shadow-lg">
        <div className="container mx-auto max-w-5xl flex justify-between items-center">
          ...
          {/* Acceso oculto mediante el Logo y Título */}
          <h1 
            onClick={manejarAccesoAdmin}
            className="flex items-center gap-2 font-black text-[24px] tracking-tighter italic uppercase cursor-pointer select-none active:scale-95 transition-transform"
          >
            <img 
              src={logo} 
              alt="Logo" 
          ...
          {/* Solo se muestra el botón de salida si ya está en la vista Admin */}
          {view === 'admin' && (
            <button 
              onClick={manejarAccesoAdmin} 
              className="bg-white text-[#f969b3] px-4 py-2 rounded-xl font-bold text-xs transition-all uppercase italic shadow-md hover:bg-slate-100"
            >
              VOLVER AL MENÚ
            </button>
          )}

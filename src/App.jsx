        ...
        <div className="animate-in zoom-in-95 duration-300">
          <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Bre-B (Transfiya) */}
              <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-[#00cfba] rounded-xl mb-4 flex items-center justify-center text-white font-black italic">Bre-V</div>
                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Llave Bre-V</p>
